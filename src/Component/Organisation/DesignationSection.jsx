                ...
                <CardContent className="space-y-3">
                    ...
                    <div className="space-y-2">
                        ...
                        <Select
                            ...
                            onValueChange={(v) =>
                                setDesignationForm((s) => ({...s, sub_dept_id: Number(v)}))
                            }
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                setDesignationForm((s) => ({...s, designation_name: e.target.value}))
                            }
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                setDesignationForm((s) => ({...s, description: e.target.value}))
                            }
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            <DeptFilter
                                ...
                                onChange={(v) => {
                                    setDeptFilter(v);
                                    setSubDeptFilter(""); // clear sub-dept when dept changes
                                }}
                                options={deptOptions}
                ...
                <CardContent>
                    <Table>
                        ...
                        <TableBody>
                            {gns.map((g) => {
                                const deptName =
                                    safeArray(depts).find((d) => d.dept_id === g.dept_id)?.dept_name || "-";
                                const subName =
                                    safeArray(subs).find((s) => s.sub_dept_id === g.sub_dept_id)?.sub_dept_name ||
                                    "-";
                                return (
