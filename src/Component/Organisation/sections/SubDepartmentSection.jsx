...
export default function SubDepartmentSection({
  departments, deptOptions, subDepartments, loadingDepts, loadingSubs,
  deptFilter, setDeptFilter, subDeptForm, setSubDeptForm, onCreate, onRefresh,
}) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      <Card className="lg:col-span-1">
        <CardHeader><CardTitle>Add Sub-Department</CardTitle></CardHeader>
        <CardContent className="space-y-3">
          ...
          <Button disabled={!subDeptForm.dept_id || !subDeptForm.sub_dept_name} onClick={onCreate} className="w-full">
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <DeptFilter value={deptFilter} onChange={setDeptFilter} options={deptOptions} loading={loadingDepts} />
            ...
            <TableBody>
              {subs.map((s) => (
                <TableRow key={s.sub_dept_id}>
                  ...
                  <TableCell>{safeArray(depts).find((d) => d.dept_id === s.dept_id)?.dept_name || "-"}</TableCell>
