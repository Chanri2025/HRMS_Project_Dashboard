...
export default function HeaderBar({setIsAuthenticated}) {
    ...
    // Read fresh each render so it picks up sessionStorage changes when App rerenders
    ...
    return (
        <div className="flex h-14 items-center px-4 justify-between w-full">
            <div className="flex items-center gap-3 ml-auto">
                ...
                {/* Logout — red circular icon button */}
                <Button
                    onClick={() => setLogoutOpen(true)}
                    variant="destructive"
                    size="icon"
                    className="rounded-sm w-10 h-10 flex items-center justify-center"
                    title="Logout">
